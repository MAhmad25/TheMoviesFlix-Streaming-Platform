                                    ...
                                    {nowPlaying.map((eachMovieCard, index) => (
                                          <div key={index} className="w-full relative shrink-0 h-full">
                                                {showSkeleton ? (
                                                      ...
                                                      <div className="bottom-0 bg-gradient px-4 text-white  py-2 left-0 flex items-end  overflow-hidden  lg:inset-0 lg:h-full w-full h-[50%] absolute">
                                                            <div className="w-full bg-transparent">
                                                                  <h1 className="text-xl font-semibold sm:text-2xl  md:text-3xl lg:text-4xl min-[1150px]:text-5xl leading-none">{(eachMovieCard.original_title && eachMovieCard.original_title) || eachMovieCard.title}</h1>
