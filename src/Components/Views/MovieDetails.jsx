...
const MovieDetails = () => {
      ...
      return (
            <>
                  {info ? (
                        <section className="w-dvw relative overflow-x-hidden  bg-bottom " style={{ backgroundImage: info.detail.backdrop_path || info.detail.poster_path ? `url(https://image.tmdb.org/t/p/original${info.detail.backdrop_path || info.detail.poster_path})` : `/icon.png` }}>
                              ...
                              <section className="backdrop-blur-2xl overflow-x-hidden  w-full min-h-full max-h-[250dvh] bg-black/30">
                                    ...
                                    <section className="px-5 overflow-x-hidden text-white  mt-3 w-full font-Stoshi">
                                          ...
                                          {info.recommendedMovies.length !== 0 && (
                                                <div className="mt-2 mb-20 sm:mb-72 md:mb-96 w-full">
                                                      <h1 className="text-white text-2xl font-bold font-Stoshi leading-none">Recommended</h1>
                                                      <div className={`flex mt-5 sm:mt-3 overflow-x-scroll min-w-[100vw] items-center md:items-start cursor-pointer  ${style.scrollbar}  gap-3 sm:h-96 h-72 `}>
