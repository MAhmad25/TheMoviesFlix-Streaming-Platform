      ...
      return (
            <div className="w-32 shrink-0   h-fit">
                  <div className="w-28 h-28  rounded-full overflow-hidden">
                        <img className="w-full h-full object-top object-cover" src={eachActor.profile_path ? `https://image.tmdb.org/t/p/original${eachActor.profile_path}` : `/noImage.jpg`} alt="" />
                  </div>
