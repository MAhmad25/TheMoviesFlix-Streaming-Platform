...
const PeopleDetails = () => {
      ...
      // console.log("People: ", info?.castedMovies??.cast);
      return (
            <>
                  {info ? (
                        <section className="min-w-screen px-3 relative min-h-[100dvh] py-10 pb-20 text-white theme-bg">
                              ...
                              <div className="w-full">
                                    <div className="w-full flex flex-col justify-center items-center">
                                          <div className="w-32 h-36 overflow-hidden rounded-2xl">
                                          ...
                                          <h1 className="font-Stoshi mt-2 text-format">{info.personDetail.name && info.personDetail.name}</h1>
                                          <h1 className="tracking-tight mt-1 leading-none">⭐{info.personDetail.popularity && info.personDetail.popularity.toFixed(0)}</h1>
                                          <div className="flex gap-2 mt-4 flex-wrap justify-center items-center">
                                                {info.castedMovies.cast.map((eachMovie, index) => {
                                                      if (eachMovie.vote_average >= 8) {
                                                            return (
                                                                  <div key={index} className="py-1 shrink-0 px-3 tracking-tighter text-xs leading-none bg-white/20  rounded-full">
                                    ...
                                    <div className="w-full mt-7">
                                          <h1 className="font-Stoshi text-2xl text-format">Personal Info:</h1>
                                          <div className="mt-2">
                              ...
                              <div className="w-full font-Stoshi mt-5">
                                    {info.personDetail.biography && (
                                          <>
                                                ...
                                                <p className="mt-4 leading-5">{info.personDetail.biography}</p>
                                          </>
                                    )}
