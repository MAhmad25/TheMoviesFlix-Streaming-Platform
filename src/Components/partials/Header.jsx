      ...
      return (
            <header className="w-full p-5 leading-none font-Stoshi">
                  <section className="overflow-hidden">
                        <motion.h1 initial={{ y: -50 }} animate={{ y: 0, transition: { duration: 0.7, delay: 0.5, ease: "backInOut" } }} className="text-2xl md:text-3xl tracking-tighter text-[#d2f5e9]">
                              MoviesFlix
                        </motion.h1>
                  ...
                  <section className="w-full h-[35vh] sm:h-[60vh] lg:h-[70vh] relative mt-3 overflow-hidden rounded-md">
                        <div className="bottom-0  px-4 text-white rounded-t-md md:rounded-t-3xl py-3 left-0 bg-gradient-to-t from-zinc-600/70 to-transparent sm:bg-gradient-to-t sm:from-zinc-800/30 sm:to-zinc-500/10 lg:bg-gradient-to-t lg:from-zinc-800/50 lg:to-zinc-800/30  overflow-hidden lg:backdrop-blur-none sm:backdrop-blur-sm  sm:w-1/2 md:h-[55%] lg:h-[45%] w-full h-[50%] absolute">
