      ...
      return (
            <header className="w-full p-5 leading-none font-Stoshi">
                  ...
                  <section className="w-full h-[35vh] sm:h-[60vh] lg:h-[70vh] relative mt-3 overflow-hidden rounded-md">
                        ...
                        <img className="w-full h-full object-cover lg:object-center  aspect-square object-top" loading="lazy" src={`https://image.tmdb.org/t/p/original${nowPlaying.poster_path || nowPlaying.backdrop_path}`} alt="" />
                  </section>
            </header>
      );
};
