...
const Navbar = () => {
      ...
      return (
            <nav className="w-full h-[10vh] flex px-6 z-30  justify-center overflow-hidden items-center fixed bottom-0 left-0 right-0 text-white backdrop-blur-md bg-[#0A1F18]/80">
