...
const Navbar = () => {
      ...
      return (
            <nav className="w-full  h-[10vh] flex px-6 z-30 justify-center mx-auto sm:w-1/2 md:w-[40%]  lg:w-[35%] min-[1150px]:w-[30%] sm:rounded-3xl overflow-hidden items-center fixed bottom-0 sm:bottom-2 md:bottom-1 left-0 right-0 text-white backdrop-blur-md  bg-[#0A1F18]/80">
